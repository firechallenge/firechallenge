...
const FireShader = () => {
  ...
  useEffect(() => {
    ...
    // --- Shader sources ---
    // Vertex Shader (same as your <script id="vs">)
    ...
    // Fragment Shader (same as your <script id="fs">)
    ...
    const iTimeUniformLocation = gl.getUniformLocation(shaderProgram, "iTime");
    ...
    const animate = (timestamp: number) => {
      ...
      // Since the shader expects a vec4 for "mouse", we supply (0.5, 0.5, 0.0, 0.0)
      gl.uniform4f(mouseUniformLocation, 0.5, 0.5, 0.0, 0.0);
      if (timeUniformLocation) gl.uniform1f(timeUniformLocation, t);
      if (iTimeUniformLocation) gl.uniform1f(iTimeUniformLocation, t);
